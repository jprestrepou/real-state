"""
Work Groups router — /api/v1/work-groups endpoints.
"""
...
from app.utils.security import get_current_user  # correct import
...
async def list_work_groups(
    ...
    """List work groups. Admins see all; others see only their own."""
    return await work_group_service.list_work_groups(db, current_user.id, current_user.role)
